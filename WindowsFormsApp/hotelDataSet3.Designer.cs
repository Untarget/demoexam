...
namespace WindowsFormsApp {
    ...
    public partial class hotelDataSet3 : global::System.Data.DataSet {
        ...
        public partial class RoomDataTable : global::System.Data.TypedTableBase<RoomRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public RoomRow AddRoomRow(int Id, string Status) {
...
namespace WindowsFormsApp.hotelDataSet3TableAdapters {
    ...
    public partial class RoomTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Room] WHERE (([Id] = @Original_Id) AND ((@IsNull_Status = 1 AN" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Room] ([Id], [Status]) VALUES (@Id, @Status);\r\nSELECT Id, Stat" +
                "us FROM Room WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Room] SET [Id] = @Id, [Status] = @Status WHERE (([Id] = @Original_I" +
                "d) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Statu" +
                "s)));\r\nSELECT Id, Status FROM Room WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Status FROM dbo.Room";
        ...
        public virtual int Fill(hotelDataSet3.RoomDataTable dataTable) {
        ...
        public virtual hotelDataSet3.RoomDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotelDataSet3.RoomDataTable dataTable = new hotelDataSet3.RoomDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotelDataSet3.RoomDataTable dataTable) {
